  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="prose prose-invert max-w-none text-slate-600 text-sm leading-relaxed space-y-6">
        <h2 className="text-lg font-bold text-black">1. Hủy đơn trước 24 giờ nhận máy</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-black">2. Hủy đơn trong vòng 24 giờ trước giờ nhận</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-black">3. Trả máy sớm hơn dự kiến</h2>
        <p>
