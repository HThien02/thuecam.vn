          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2 pt-2 text-xs text-slate-700">
              ...
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-[#0284c7] shrink-0 mt-0.5" />
                <span>
                  <strong className="text-slate-900">Chi nhánh Hà Nội:</strong> 45 Phố Giảng Võ, P. Cát Linh, Q. Đống Đa
                </span>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#0284c7] shrink-0" />
                <span>Hotline / Zalo: <strong className="text-[#0284c7]">0932.501.411</strong> (08:00 - 21:30 hàng ngày)</span>
              </div>
              <div className="flex items-center gap-2.5">
